...
public class CreatePlane : ScriptableWizard
{
    ...
    void OnWizardCreate ()
    {
        ...
        Mesh m = (Mesh)AssetDatabase.LoadAssetAtPath("Assets/Overworld/Editor/" + planeAssetName, typeof(Mesh));
        ...
        if (m == null)
        {
            ...
            AssetDatabase.CreateAsset(m, "Assets/Overworld/Editor/" + planeAssetName);
